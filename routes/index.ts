...
const routes = [
	...
	},
	{
		...
		children : [
			...
			{
				path: '/credits/apply/:id',
				component: CreditsApply,
				meta: { requires_auth: true }
			},
			{
			...
			{
				path: '/payments/payments/apply/:id',
				component: PaymentsApply,
				meta: { requires_auth: true }
			},
			{
			...
			},
			{
				...
				component: PaymentsSettingsRender,
				meta: { requires_auth: true },
				children : [
					{
						path:  '/settings/payments/integrations',
					...
					{
						path:  '/settings/payments/integrations/stripe',
						component: PaymentSettingsStripe,
						meta: { requires_auth: true }
					}
