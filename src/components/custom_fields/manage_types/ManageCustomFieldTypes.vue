	...
	<section class="main-content">
		<div class="card">
			...
			<span v-if="!data_loading" class="">
				...
				<br>
				<data-table :data="table_data" :show_search="true" @deleted_row_id="handleDeleted" :paginate="true" :checkbox_actions="['Delete', 'Export CSV']" @deleted_rows="handleMultipleDelete" :static="false" url_slug="custom-fields/manage-field-types" :datetime_filter="true" :row_actions="['edit', 'delete']" :total_pages="total_pages" @handle_api="handleAPI" :dynamic_loading_status="dynamic_loading_status"></data-table>
			</span>
