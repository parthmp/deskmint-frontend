<template>
	<section class="main-content">
		<div class="card">
			<h1 class="text-2xl!">Edit Clients Custom Field</h1>
			...
			<form v-if="!data_loading" @submit.prevent="saveClientCustomField" class="form">
...
<script lang="ts">
	...
	export default defineComponent({
		...
		methods : {
			...
			fetchCustomFieldData() : void{
				api.get('clients-custom-fields/'+this.$route.params.id).then((response) => {
