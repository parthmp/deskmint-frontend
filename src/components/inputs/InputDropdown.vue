<template>
	<div class="form-group" ref="dropdownWrapper">
		...
		<button id="dropdown_default" class="flex gap-1 items-center bg-deskmint-original-dark text-white py-[7px] px-[15px] rounded-lg w-full lg:w-[initial]" data-dropdown-toggle="dropdown" type="button" @click="show_menu = !show_menu"> {{ modelValue }} <span class="transition-all duration-300" :class="{'rotate-180':show_menu}"><IconChevronDown :size="22"></IconChevronDown></span></button>
