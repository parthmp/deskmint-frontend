	...
	<div>
		...
		<div v-if="!data.loading">
			...
			<form @submit.prevent="saveEmailSettingsContent">
				...
				<input-textarea v-model="data.email_content_payment_request" :rows="6" label="Email content to send for payment requests (Only {$client_first_name}, {$client_last_name}, {$unpaid_balance} and {$payment_url} available for this)" placeholder="Email content to send for payment requests"></input-textarea>
				<input-textarea v-model="data.email_content_reminder_payment_request" :rows="6" label="Email content to send for payment requests reminders (Only {$client_first_name}, {$client_last_name}, {$unpaid_balance} and {$payment_url} available for this)" placeholder="Email content to send for payment requests reminders"></input-textarea>
