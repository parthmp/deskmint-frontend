<template>
	<general-index-page page_title="Manage invoices" :enable_arranged_columns="true" base_url="manage-invoices" slug="invoices" :actions="['view','edit', 'delete', cancel_data,add_payment, add_credit,'download PDF', 'send Invoice']" @action="handleAction" :checkbox_actions="['Delete', 'Export CSV']"></general-index-page>
