<template>
    ...
    <div class="card">
        ...
        <br>
        <data-table :data="table_data" :per_page="per_page" @deleted_row_id="handleDeleted" :paginate="true" :checkbox_actions="['Delete', 'Export CSV']" @deleted_rows="handleMultipleDelete" :total_pages="5" :static="false" url_slug="clients" @handle_api="handleAPI"></data-table>
