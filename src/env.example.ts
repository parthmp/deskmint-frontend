const BASEURL = "/"; /* make sure to have slash in the end, this is to connect to the backend */
const FRONTEND_BASEURL = "/"; /* make sure to have slash in the end, this is used for auto highlight menus on sidebar on refresh */
